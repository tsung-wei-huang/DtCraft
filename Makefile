...
pkgdatadir = $(datadir)/DtCraft
pkgincludedir = $(includedir)/DtCraft
pkglibdir = $(libdir)/DtCraft
pkglibexecdir = $(libexecdir)/DtCraft
...
am_lib_libDtCraft_la_OBJECTS = src/device.lo src/statgrab/statgrab.lo \
	...
	src/ipc/socket.lo src/ipc/block_file.lo src/ipc/ipc.lo \
...
am__v_at_0 = @
am__v_at_1 = 
DEFAULT_INCLUDES = -I. -I$(top_builddir)/include/dtc
...
ACLOCAL = ${SHELL} /home/twhuang/PhD/Code/DtCraft/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/twhuang/PhD/Code/DtCraft/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/twhuang/PhD/Code/DtCraft/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/twhuang/PhD/Code/DtCraft/build-aux/missing automake-1.15
AWK = mawk
CC = gcc
...
# CXX flags
CXXFLAGS = -g -O2 -std=c++1z -Wall $(PTHREAD_CFLAGS)
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
# Libraries
LIBS =  -lstdc++fs $(PTHREAD_LIBS)
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/twhuang/PhD/Code/DtCraft/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
OTOOL64 = 
PACKAGE = DtCraft
PACKAGE_BUGREPORT = dtcraft.engine@gmail.com
PACKAGE_NAME = DtCraft
PACKAGE_STRING = DtCraft 0.2.3
PACKAGE_TARNAME = DtCraft
PACKAGE_URL = http://dtcraft.web.engr.illinois.edu/
...
YACC = yacc
YFLAGS = 
abs_builddir = /home/twhuang/PhD/Code/DtCraft
abs_srcdir = /home/twhuang/PhD/Code/DtCraft
abs_top_builddir = /home/twhuang/PhD/Code/DtCraft
abs_top_srcdir = /home/twhuang/PhD/Code/DtCraft
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/twhuang/PhD/Code/DtCraft/build-aux/install-sh
...
nobase_pkginclude_HEADERS = include/dtc/archive/binary.hpp \
	...
	include/dtc/event/demux.hpp include/dtc/event/epoll.hpp \
	include/dtc/event/event.hpp include/dtc/ipc/notifier.hpp \
	include/dtc/ipc/streambuf.hpp include/dtc/ipc/domain.hpp \
	include/dtc/ipc/block_file.hpp include/dtc/ipc/pipe.hpp \
	include/dtc/ipc/fifo.hpp include/dtc/ipc/ipc.hpp \
	include/dtc/ipc/shm.hpp include/dtc/ipc/ios.hpp \
	include/dtc/ipc/socket.hpp include/dtc/headerdef.hpp \
	include/dtc/utility/os.hpp include/dtc/utility/allocator.hpp \
	...
	include/dtc/utility/singleton.hpp include/dtc/utility/json.hpp \
	...
	include/dtc/macrodef.hpp include/dtc/utility.hpp \
	include/dtc/kernel/executor.hpp include/dtc/kernel/manager.hpp \
	include/dtc/kernel/vertex.hpp include/dtc/kernel/graph.hpp \
	include/dtc/kernel/scheduler.hpp include/dtc/kernel/master.hpp \
	include/dtc/kernel/container.hpp include/dtc/kernel/agent.hpp \
	include/dtc/kernel/cgroup.hpp include/dtc/kernel/stream.hpp \
	include/dtc/policy.hpp include/dtc/webui/webui.hpp
dist_bin_SCRIPTS = 
...
lib_libDtCraft_la_SOURCES = src/device.cpp src/statgrab/statgrab.cpp \
	...
	src/ipc/socket.cpp src/ipc/block_file.cpp src/ipc/ipc.cpp \
...
src/ipc/socket.lo: src/ipc/$(am__dirstamp) \
	src/ipc/$(DEPDIR)/$(am__dirstamp)
src/ipc/block_file.lo: src/ipc/$(am__dirstamp) \
	src/ipc/$(DEPDIR)/$(am__dirstamp)
...
src/protobuf/$(DEPDIR)/$(am__dirstamp):
	...
	@: > src/protobuf/$(DEPDIR)/$(am__dirstamp)
src/protobuf/loadinfo.lo: src/protobuf/$(am__dirstamp) \
	src/protobuf/$(DEPDIR)/$(am__dirstamp)
...
include app/debs18/$(DEPDIR)/debs18.Po
include app/debs18/$(DEPDIR)/dnn.Po
include app/debs18/$(DEPDIR)/dtr.Po
include app/debs18/$(DEPDIR)/map.Po
include app/debs18/$(DEPDIR)/utility.Po
include example/$(DEPDIR)/external.Po
include example/$(DEPDIR)/feeder.Po
include example/$(DEPDIR)/hello_world.Po
include example/$(DEPDIR)/kmeans.Po
include example/$(DEPDIR)/mnist.Po
include example/$(DEPDIR)/operator.Po
include example/$(DEPDIR)/pi.Po
include example/$(DEPDIR)/prime.Po
include example/$(DEPDIR)/prober.Po
include example/$(DEPDIR)/reduce_sum.Po
include main/$(DEPDIR)/agent.Po
include main/$(DEPDIR)/master.Po
include src/$(DEPDIR)/device.Plo
include src/$(DEPDIR)/error.Plo
include src/$(DEPDIR)/exit.Plo
include src/$(DEPDIR)/policy.Plo
include src/csv/$(DEPDIR)/csv.Plo
include src/event/$(DEPDIR)/epoll.Plo
include src/event/$(DEPDIR)/event.Plo
include src/event/$(DEPDIR)/reactor.Plo
include src/event/$(DEPDIR)/select.Plo
include src/ipc/$(DEPDIR)/block_file.Plo
include src/ipc/$(DEPDIR)/domain.Plo
include src/ipc/$(DEPDIR)/fifo.Plo
include src/ipc/$(DEPDIR)/ipc.Plo
include src/ipc/$(DEPDIR)/notifier.Plo
include src/ipc/$(DEPDIR)/pipe.Plo
include src/ipc/$(DEPDIR)/shm.Plo
include src/ipc/$(DEPDIR)/socket.Plo
include src/ipc/$(DEPDIR)/streambuf.Plo
include src/kernel/$(DEPDIR)/agent.Plo
include src/kernel/$(DEPDIR)/cgroup.Plo
include src/kernel/$(DEPDIR)/container.Plo
include src/kernel/$(DEPDIR)/executor.Plo
include src/kernel/$(DEPDIR)/graph.Plo
include src/kernel/$(DEPDIR)/manager.Plo
include src/kernel/$(DEPDIR)/master.Plo
include src/kernel/$(DEPDIR)/scheduler.Plo
include src/kernel/$(DEPDIR)/stream.Plo
...
include src/protobuf/$(DEPDIR)/frontier.Plo
include src/protobuf/$(DEPDIR)/loadinfo.Plo
include src/protobuf/$(DEPDIR)/protobuf.Plo
include src/protobuf/$(DEPDIR)/resource.Plo
include src/protobuf/$(DEPDIR)/solution.Plo
include src/protobuf/$(DEPDIR)/taskinfo.Plo
include src/protobuf/$(DEPDIR)/topology.Plo
include src/statgrab/$(DEPDIR)/statgrab.Plo
include src/utility/$(DEPDIR)/http_parser.Plo
include src/utility/$(DEPDIR)/os.Plo
include src/utility/$(DEPDIR)/table.Plo
include src/webui/$(DEPDIR)/webui.Plo
include unittest/$(DEPDIR)/archive.Po
include unittest/$(DEPDIR)/concurrent.Po
include unittest/$(DEPDIR)/ipc.Po
include unittest/$(DEPDIR)/ml.Po
include unittest/$(DEPDIR)/reactor.Po
include unittest/$(DEPDIR)/scheduler.Po
include unittest/$(DEPDIR)/statgrab.Po
include unittest/$(DEPDIR)/traits.Po
include unittest/$(DEPDIR)/utility.Po
include unittest/$(DEPDIR)/webui.Po
