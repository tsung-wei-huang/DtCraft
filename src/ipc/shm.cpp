...
//std::streamsize SharedMemory::read(void* given, std::streamsize sz, std::error_code& errc) {
//
//  errc.clear();
//
...
//    errc = make_posix_error_code(EAGAIN);
//    return -1;
//  }
//
//  // Clear notify
...
//// Function: write
//std::streamsize SharedMemory::write(const void* given, std::streamsize sz, std::error_code& errc) {
//
//  errc.clear();
//  
